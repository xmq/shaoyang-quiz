...
PAGE_CONFIGS = {
    "lecture": {
        ...
        "directory_description": "适合零基础先理解定义、组成、分类、作用和易混概念；只保留必要的一步计算，学完一章再用三色回忆卡练简答、到题库做判断和选择。",
    ...
    "color-notes": {
        ...
        "directory_description": "用于学完讲义后的主动回忆：默认只显示问题，先按事业单位简答题的方式口述或默写，再核对最小答案、得分关键词和判断陷阱。",
