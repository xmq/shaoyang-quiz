...
- 题库总量：**2531 道**，全部纳入公开练习，已按同科规范化题干去重。
...
- 16 个零基础讲义科目用于系统理解概念、原理、特点、作用和基础例题。
- 16 个三色笔记科目按考频划分为红色高频、蓝色中频、黑色低频，每条包含知识点、常见考法和易错边界。
...
- `course_notes/*.md`：16 个科目讲义的唯一可编辑数据源。
- `color_notes/*.md`：16 个科目三色笔记内容的唯一可编辑数据源。
