...
- 15 个三色回忆科目采用单卡主动回忆：揭示后按“不记得 / 有点模糊 / 记住了”自评，未掌握卡会在本章末再次出现。
...
- 限时模拟采用交卷后统一判分，支持 20/30/50 题、自动交卷、跳题统计和薄弱能力提示；普通练习仍保留即时反馈。
...
- `quiz.html` / `app.js`：专项刷题、限时模拟、错题、交错练习、到期复习与进度管理。
